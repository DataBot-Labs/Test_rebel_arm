...
namespace rebel_arm_hardware_interface
{
    class RebelArmHardwareInterface : public hardware_interface::SystemInterface
    {
        ...
        {
            std::string position1JointName = "joint_1";
            std::string position2JointName = "joint_2";
            std::string position3JointName = "joint_3";
            std::string position4JointName = "joint_4";
            std::string position5JointName = "joint_5";
            std::string position6JointName = "joint_6";
        };
